...
rm -rf ${DIR}/../app/resources/output/nba_players_historical2 
rm -rf ${DIR}/../app/resources/output/mlb_players_historical2 
rm -rf ${DIR}/../app/resources/output/nba_players_current2 
rm -rf ${DIR}/../app/resources/output/mlb_players_current2 
